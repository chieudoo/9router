 ...
 * CLIProxyAPIPlus reference implementation, scoped down to what xproxy needs:
 *
 ...
 *
 * Kiro upstream does not advertise `-agentic` model IDs; they are a xproxy
 ...
 * The suffix is a xproxy request override, not part of Kiro's upstream model id.
 */
...
/**
 * Detect whether a model id refers to a xproxy synthetic agentic variant.
...
/**
 * Detect whether a model id is a xproxy synthetic thinking variant
...
/**
 * Resolve a xproxy model id to the real upstream Kiro model id, plus flags
