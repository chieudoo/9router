 ...
 * API. They are xproxy fictions and the `openai-to-kiro` translator strips
...
/**
 * Build the synthetic xproxy variant set for a single upstream Kiro model.
 *
 ...
 * into xproxy variants (`-thinking`, `-agentic`, `-thinking-agentic`).
 *
