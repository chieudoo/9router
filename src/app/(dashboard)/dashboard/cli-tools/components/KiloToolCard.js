...
export default function KiloToolCard({ tool, isExpanded, onToggle, baseUrl, apiKeys, activeProviders, initialStatus, tunnelEnabled, tunnelPublicUrl, tailscaleEnabled, tailscaleUrl }) {
  ...
  const getConfigStatus = () => {
    ...
    return status.hasXProxy ? "configured" : "not_configured";
  };
