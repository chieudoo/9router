...
// and break recursive loops between xproxy instances connected to each other.
const INTERNAL_MODELS_FETCH_HEADER = "x-xp-internal-models-fetch";
...
export async function buildModelsList(kindFilter, options = {}) {
  ...
  // xproxy instance's fetchCompatibleModelIds — skip dynamic fetch to break
...
export async function GET(request) {
  try {
    // Detect cross-instance recursive /models fetch (another xproxy fetching our /models)
