...
// Build TOML config for XProxy (openai provider mode)
const buildXProxyConfig = (baseUrl, apiKey, model) => {
...
// Detect XProxy by checking if provider is "openai" and base_url points to localhost/127.0.0.1
...
export async function POST(request) {
    try {
        ...
        const newConfig = buildXProxyConfig(baseUrl, apiKey || "sk_xproxy", model);
